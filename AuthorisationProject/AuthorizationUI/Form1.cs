...
namespace AuthorizationUI
{
    public partial class AuthorizationForm : Form
    {
        ...
        private void SubdivisionNameTextBox_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                SubdivisionNameTextBox.Text = String.Empty;
        ...
        private void SetSubdivisions()
        {
            ...
            subdivisions.Insert(0, string.Empty);
        ...
        {
            var result = string.IsNullOrEmpty(ASVFTextBox.Text)
            && string.IsNullOrEmpty(AgentNameTextBox.Text)
            && string.IsNullOrEmpty(AgentAddressTextBox.Text)
            && string.IsNullOrEmpty(AgentPhoneTextBox.Text)
            && string.IsNullOrEmpty(ObjectNameTextBox.Text)
            && string.IsNullOrEmpty(ObjectPhoneTextBox.Text)
            && string.IsNullOrEmpty(ObjectAddressTextBox.Text);

            if (SubdivisionsComboBoxInsertTab.Text == string.Empty)
            {
                result = result && string.IsNullOrEmpty(SubdivisionNameTextBox.Text)
                && string.IsNullOrEmpty(SubdivizionPhoneTextBox.Text)
                && string.IsNullOrEmpty(LeaderFirstNameTextbox.Text)
                && string.IsNullOrEmpty(LeaderLastNameTextBox.Text);
            }
        ...
        private ICollection GetFilteredData()
        {
            var result = _dbContext.Authorizations.Include(ap => ap.ActivityProfiles)
                                                 ...
                                                 .Select(at => new AuthorisationModel
                                                 {
                                                     ...
                                                     Activities = at.ActivityProfiles.Select(ac => ac.Activity)
